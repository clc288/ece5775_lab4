...
set rc [catch {
  ...
  /home/clc288/lab4/ecelinux/zedboard_project/xillybus/vivado/xillydemo.cache/ip
  /home/clc288/lab4/ecelinux/zedboard_project/vivado-essentials/vivado-ip
} [current_project]
  set_property ip_output_repo /home/clc288/lab4/ecelinux/zedboard_project/xillybus/vivado/xillydemo.cache/ip [current_project]
...
set rc [catch {
  ...
  route_design 
  set src_rc [catch { 
    puts "source /home/clc288/lab4/ecelinux/zedboard_project/vivado-essentials/showstopper.tcl"
    source /home/clc288/lab4/ecelinux/zedboard_project/vivado-essentials/showstopper.tcl
  } _RESULT] 
  if {$src_rc} { 
    send_msg_id runtcl-1 error "$_RESULT"
    send_msg_id runtcl-2 error "sourcing script /home/clc288/lab4/ecelinux/zedboard_project/vivado-essentials/showstopper.tcl failed"
    return -code error
  }
