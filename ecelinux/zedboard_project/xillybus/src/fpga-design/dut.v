...
(* CORE_GENERATION_INFO="dut,hls_ip_2016_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.720750,HLS_SYN_LAT=128125,HLS_SYN_TPT=none,HLS_SYN_MEM=58,HLS_SYN_DSP=46,HLS_SYN_FF=7500,HLS_SYN_LUT=8466}" *)
...
assign i_2_fu_138_p2 = (i_reg_95 + ap_const_lv10_1);

assign p_Result_s_fu_124_p3 = {{tmp_69_fu_120_p1}, {tmp_V_2_reg_149}};

assign strm_out_V_V_din = result_q0;

assign tmp_69_fu_120_p1 = strm_in_V_V_dout[16:0];
