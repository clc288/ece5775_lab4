...
*/
const fixed16_t w_conv1[MAX_W_CONV] = { //288 
  #include "data/weight_1.dat" 
};

const fixed16_t b_conv1[MAX_B_CONV] = { //32
  #include "data/weight_2.dat"
};

const fixed16_t w_conv2[MAX_W_CONV] = { //18432
  #include "data/weight_3.dat" 
};

const fixed16_t b_conv2[MAX_B_CONV] = { //64
  #include "data/weight_4.dat"
};
#endif
